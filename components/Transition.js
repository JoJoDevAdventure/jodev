...
const Transition = () => {
  return (
    <>
      ...
      <motion.div className='fixed top-0 bottom-0 right-full w-screen h-screen z-20 bg-[#a03bab]'
      ...
      <motion.div className='fixed top-0 bottom-0 right-full w-screen h-screen z-10 bg-[#ff42ef]'
