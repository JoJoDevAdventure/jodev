...
const Transition = () => {
  return (
    <>
      ...
      <motion.div className='fixed top-0 bottom-0 right-full w-screen h-screen z-20 bg-[#711616]'
      ...
      <motion.div className='fixed top-0 bottom-0 right-full w-screen h-screen z-10 bg-[#d52929]'
